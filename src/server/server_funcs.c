...
void new_position(int* x, int *y, int *cauda_x[], int *cauda_y[], direction_t direction){
        ...
        case UP:
            ...
            else if(*x==WINDOW_SIZE-2 || *x==WINDOW_SIZE-3 || *x==WINDOW_SIZE-4 || *x==WINDOW_SIZE-5) //para a cauda ficar dentro da janela
            {
                *x = WINDOW_SIZE-7;
                for (i=0;i<5;i++)
                    {
        ...
        case DOWN:
            ...
            else if (*x==1 || *x==2 || *x==3 || *x==4) //para a cauda ficar dentro da janela
            {
                *x = 6;
                for (i=0;i<5;i++)
                    {
        ...
        case LEFT:
            ...
            else if(*y==WINDOW_SIZE-2 || *y==WINDOW_SIZE-3 || *y==WINDOW_SIZE-4 || *y==WINDOW_SIZE-5) //para a cauda ficar dentro da janela
            {
                *y = WINDOW_SIZE-7;
                for (i=0;i<5;i++)
                    {
        ...
        case RIGHT:
            ...
            else if (*y==1 || *y==2 || *y==3 || *y==4) //para a cauda ficar dentro da janela
            {
                *y = 6;
                for (i=0;i<5;i++)
                    {
